<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1542974935,
    'editedby' => 1,
    'editedon' => 1544183817,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1542974880,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<head>
	<meta charset="UTF-8">
	<title>Детская поликлиника №58 | Поликлиника №8 Официальный сайт</title>
...
<li class="active"><a href="index.php?id=11" title="Детская поликлиника №58" >Детская поликлиника №58</a></li>
		...
		<div class="col-lg-8 base_cont">
			<div class="row">
				<div class="col-lg-12 hello_guest">
					<div class="row footbanner"><a class="btn btn-primary line-btn" href="index.php?id=8">Pусановская 17</a> <a class="btn btn-primary line-btn" href="index.php?id=9">ДПО №33</a> <a class="btn btn-primary line-btn" href="index.php?id=10">Филиал ДПО №33</a> <a class="btn btn-primary line-btn" href="index.php?id=11">ДПО №58</a></div>
				</div>
			</div>
		</div>
		<!--banner box-->
...
<li class="last"><a href="index.php?id=27" title="Контакты" >Контакты</a></li>
    ...
    '[[$filials]]' => '<div class="row footbanner"><a class="btn btn-primary line-btn" href="index.php?id=8">Pусановская 17</a> <a class="btn btn-primary line-btn" href="index.php?id=9">ДПО №33</a> <a class="btn btn-primary line-btn" href="index.php?id=10">Филиал ДПО №33</a> <a class="btn btn-primary line-btn" href="index.php?id=11">ДПО №58</a></div>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
    array (
      ...
      array (
        ...
        array (
          ...
          'name' => 'filials',
          'description' => 'Кнопки для Филиалов ГП№8',
          'editor_type' => 0,
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<div class="row footbanner"><a class="btn btn-primary line-btn" href="[[~8]]">Pусановская 17</a> <a class="btn btn-primary line-btn" href="[[~9]]">ДПО №33</a> <a class="btn btn-primary line-btn" href="[[~10]]">Филиал ДПО №33</a> <a class="btn btn-primary line-btn" href="[[~11]]">ДПО №58</a></div>',
          'locked' => false,
          'properties' => 
          array (
          ),
          'static' => false,
          'static_file' => '',
          'content' => '<div class="row footbanner"><a class="btn btn-primary line-btn" href="[[~8]]">Pусановская 17</a> <a class="btn btn-primary line-btn" href="[[~9]]">ДПО №33</a> <a class="btn btn-primary line-btn" href="[[~10]]">Филиал ДПО №33</a> <a class="btn btn-primary line-btn" href="[[~11]]">ДПО №58</a></div>',
        ),
        'policies' => 
        array (
        ),
